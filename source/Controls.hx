	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			...
			case QWOP:
				...
				inline bindKeys(Control.RESET, [R]);
			case ZXCOMMAPERIOD:
				inline bindKeys(Control.UP, [COMMA, FlxKey.UP]);
				inline bindKeys(Control.DOWN, [X, FlxKey.DOWN]);
				inline bindKeys(Control.LEFT, [FlxKey.LEFT]);
				inline bindKeys(Control.RIGHT, [PERIOD, FlxKey.RIGHT]);
				inline bindKeys(Control.ACCEPT, [SPACE, ENTER]);
				inline bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
				inline bindKeys(Control.PAUSE, [P, ENTER, ESCAPE]);
				inline bindKeys(Control.RESET, [R]);
		...
		switch (scheme)
		{
			...
			case QWOP:
				...
				bindKeys(Control.RESET, [R]);
			case ZXCOMMAPERIOD:
				bindKeys(Control.UP, [COMMA, FlxKey.UP]);
				bindKeys(Control.DOWN, [X, FlxKey.DOWN]);
				bindKeys(Control.LEFT, [FlxKey.LEFT]);
				bindKeys(Control.RIGHT, [PERIOD, FlxKey.RIGHT]);
				bindKeys(Control.ACCEPT, [SPACE, ENTER]);
				bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
				bindKeys(Control.PAUSE, [P, ENTER, ESCAPE]);
				bindKeys(Control.RESET, [R]);
